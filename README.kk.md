...
> ⚠️ `APP_*` параметрлері нақты Kaspi Pay клиентіне сәйкес келеді. Kaspi API бұл мәндерді тексереді және белгісіз параметрлері бар сұрауларды қабылдамауы мүмкін. Қосымшаның жаңа нұсқасы шыққанда, нақты құрылғының cookie деректерін пайдаланып жаңартыңыз.
